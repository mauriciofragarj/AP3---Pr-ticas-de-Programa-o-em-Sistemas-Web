function script_quizz()
{
	...
	if (resultado == 0) {return window.alert("Você acertou 0 de 10 perguntas. Isto é embaraçoso.");};
	if (resultado == 1) {return window.alert("Você acertou somente " + resultado + " de 10 questões. Provavelmente já ouviu falar em História da Arte.");};
	if (resultado == 2) {return window.alert("Você acertou somente " + resultado + " de 10 questões. História da Arte não parece ser a sua praia.");};
	if (resultado == 3) {return window.alert("Você acertou somente " + resultado + " de 10 questões. Você conhece algo sobre História da Arte.");};
	...
	if (resultado == 7) {return window.alert("Você acertou  " + resultado + " de 10 questões. Você parece entender bastante sobre História da Arte!");};
	if (resultado == 8) {return window.alert("Você acertou  " + resultado + " de 10 questões. Você tem futuro em História da Arte!");};
	if (resultado == 9) {return window.alert("Você acertou  " + resultado + " de 10 questões. Um resultado quase perfeito.");};
	if (resultado == 10) {return window.alert("Parabéns! Você acertou 10 de 10 questões! Genial!!!");};
}
